...
CREATE INDEX IF NOT EXISTS analyst_runs_market_symbol_idx
    ON analyst_runs(market, symbol);

CREATE INDEX IF NOT EXISTS analyst_runs_created_at_idx
    ON analyst_runs(created_at DESC);
...
CREATE INDEX IF NOT EXISTS paper_proposals_portfolio_idx
    ON paper_trade_proposals(portfolio_id, status, created_at DESC);
